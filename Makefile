...
CC  = /home/szirog/build/openpli30/openpli-oe-core/build-vuuno/tmp/sysroots/x86_64-linux/usr/bin/mips32el-oe-linux/mipsel-oe-linux-gcc
# CC  = gcc
...
#######all: open2300 dump2300 dumpconfig2300 log2300 fetch2300 wu2300 cw2300 history2300 histlog2300 bin2300 xml2300 light2300 interval2300 minmax2300 mysql2300 mysqlhistlog2300

####### Build rules for Vu+ kernel

all: open2300 dump2300 log2300 fetch2300 wu2300 cw2300 history2300 histlog2300 bin2300 xml2300 light2300 interval2300 minmax2300 sqlitelog2300 dumpconfig2300 sqlitehistlog2300
...
sqlitehistlog2300:
	$(CC) $(CFLAGS) -o sqlitehistlog2300 sqlitehistlog2300.c rw2300.c linux2300.c $(CC_LDFLAGS) $(CC_WINFLAG)  -lsqlite3
...
clean:
	rm -f *~ *.o open2300 dump2300 log2300 fetch2300 wu2300 cw2300 history2300 histlog2300 bin2300 xml2300 mysql2300 pgsql2300 light2300 interval2300 minmax2300 mysql2300 mysqlhistlog2300 sqlitelog2300 dumpconfig2300 sqlitehistlog2300
